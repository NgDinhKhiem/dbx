...
#[cfg(test)]
pub fn start_streaming_xlsx_workbook<W: Write + Seek>(
    writer: W,
...
#[cfg(test)]
pub fn start_streaming_xlsx_workbook_with_trailing_sheets<W: Write + Seek>(
    writer: W,
    sheet_name: Option<&str>,
    columns: &[String],
    column_types: &[String],
...
pub fn start_streaming_xlsx_workbook_with_options<W: Write + Seek>(
    writer: W,
    sheet_name: Option<&str>,
    columns: &[String],
    column_types: &[String],
...
#[cfg(test)]
pub fn start_streaming_xlsx_workbook_with_max_rows<W: Write + Seek>(
    writer: W,
    sheet_name: Option<&str>,
    columns: &[String],
    column_types: &[String],
...
pub fn finish_streaming_xlsx_workbook<W: Write + Seek>(writer: StreamingXlsxWriter<W>) -> Result<W, String> {
    writer.finish()
}
...
fn split_sheets_for_max_rows<'a>(
    ...
    // (production uses XLSX_MAX_DATA_ROWS), but this is pub-reachable
...
/// and autoFilter).
pub fn build_xlsx_workbook_multi_with_max_rows(
    sheets: &[XlsxWorksheetData],
    max_data_rows_per_sheet: usize,
    date_time_format: Option<&str>,
) -> Result<Vec<u8>, String> {
