...
export const MCP_TOOL_OPTIONS = [
  ...
  { name: "dbx_kafka_cluster", labelKey: "settings.mcpToolKafkaCluster" },
  { name: "dbx_kafka_list_topics", labelKey: "settings.mcpToolKafkaListTopics" },
  { name: "dbx_kafka_describe_topic", labelKey: "settings.mcpToolKafkaDescribeTopic" },
  { name: "dbx_kafka_topic_config", labelKey: "settings.mcpToolKafkaTopicConfig" },
  { name: "dbx_kafka_list_consumer_groups", labelKey: "settings.mcpToolKafkaListConsumerGroups" },
  { name: "dbx_kafka_consumer_group", labelKey: "settings.mcpToolKafkaConsumerGroup" },
  { name: "dbx_kafka_lag", labelKey: "settings.mcpToolKafkaLag" },
  { name: "dbx_kafka_throughput", labelKey: "settings.mcpToolKafkaThroughput" },
  { name: "dbx_opensearch_list_indices", labelKey: "settings.mcpToolOpensearchListIndices" },
  { name: "dbx_opensearch_resolve_pattern", labelKey: "settings.mcpToolOpensearchResolvePattern" },
  { name: "dbx_opensearch_fields", labelKey: "settings.mcpToolOpensearchFields" },
  { name: "dbx_opensearch_search", labelKey: "settings.mcpToolOpensearchSearch" },
  { name: "dbx_opensearch_sql", labelKey: "settings.mcpToolOpensearchSql" },
  { name: "dbx_opensearch_ppl", labelKey: "settings.mcpToolOpensearchPpl" },
