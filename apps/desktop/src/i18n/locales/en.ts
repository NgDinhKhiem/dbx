...
export default {
  ...
  pluginPlatform: {
    ...
    allowUnsignedSessionWarning: "Unsigned packages are allowed until DBX restarts. Any .dbxp or URL you install now skips signature verification and can run native code with your user permissions.",
    ...
    workbenchNavigationBlocked: "The plugin page tried to navigate away from its sandboxed document and was stopped. Reload it only if you trust this plugin.",
    reloadWorkbench: "Reload plugin page",
  },
  auth: {
    ...
    setupTokenHint: "Copy the one-time setup token from the DBX server log (for Docker: docker logs <container>).",
    setupTokenInvalid: "Invalid setup token. Copy it again from the DBX server log.",
    hostNotAllowed: "This host name is not allowed. Add it to DBX_ALLOWED_HOSTS on the server.",
    passwordManagedByEnv: "The password is set by the DBX_PASSWORD environment variable. Change DBX_PASSWORD and restart DBX Web instead.",
  },
  toolbar: {
  ...
  connection: {
    ...
    savedSecretPlaceholder: "Saved — leave blank to keep",
    savedSecretsTitle: "Saved secrets",
    savedSecretsHint: "Saved secrets are never shown. Leave a field blank to keep its saved value, type a new value to replace it, or clear it here.",
    savedSecretClear: "Clear saved",
    savedSecretUndo: "Undo",
    savedSecretCleared: "Removed on save",
    savedSecretConnectionString: "Connection string",
    savedSecretUrlParams: "Sensitive URL parameters",
    savedSecretUrlParamsHint: "Hidden sensitive parameter values (e.g. password=) are kept when left empty.",
    savedSecretInitScript: "Saved init script is hidden — leave empty to keep it, or type a new script to replace it.",
    savedSecretPluginField: "Plugin secret ({key})",
    savedSecretLayerField: "{layer} · {field}",
    note: "Notes",
    noteShow: "Show",
  ...
  tableVGroup: {
    ...
    groupDeleted: "Group deleted",
    groupsMenu: "Table Groups",
    databaseGroupsMenu: "Database Groups",
    moveDatabaseToGroup: "Move to Database Group",
    newDatabaseGroup: "New Database Group",
    newDatabaseRuleGroup: "New Database Group from Regex",
    newDatabaseRuleGroupMenu: "New Group from Regex...",
    newRuleGroup: "New Group from Regex",
    newRuleGroupMenu: "New Group from Regex...",
    newRuleSubgroup: "New Subgroup from Regex...",
    addRule: "Add Regex Rule...",
    editRule: "Edit Regex Rule",
    saveRule: "Save Rule",
    clearRule: "Remove Rule",
    useRules: "Group by Regex Rules Again",
    patternLabel: "Regular expression",
    patternIgnoreCase: "Ignore case",
    patternInvalid: "Invalid regular expression: {message}",
    patternTooLong: "The pattern is too long (max 500 characters).",
    patternMatchCount: "Matches {count} of {total} loaded",
    patternMoreMatches: "...and {count} more",
    patternHint: "Items you put in a group by hand stay there. Everything else joins the first rule group whose pattern matches, including databases and tables added later.",
  },
  connectionGroup: {
  ...
  configExport: {
    ...
    passphraseTooShortMin: "Passphrase must be at least {min} characters",
    passphraseMinLengthHint: "Use at least {min} characters.",
  ...
  ai: {
    ...
    savedSecretPlaceholder: "Saved — leave blank to keep",
    clearSavedSecret: "Clear saved value",
  ...
  esDiscover: {
    ...
    placeholders: {
      dql: "Search with DQL, e.g. level:ERROR and service.name:api*",
      lucene: "Search with Lucene, e.g. level:ERROR AND message:timeout",
      ppl: "PPL, e.g. where level = 'ERROR' {'|'} stats count() by service.name (source= is added automatically)",
      sql: "SQL, e.g. SELECT level, COUNT(*) FROM `logs-*` GROUP BY level",
    },
    refresh: "Refresh",
    ...
    apply: "Apply",
    rangeHint: "Local time or date math (now-1h)",
    invalidRange: "Invalid time range",
    dqlSyntaxError: "DQL syntax error",
    addFilter: "Add filter",
    removeFilter: "Remove filter",
    includeResults: "Include results",
    excludeResults: "Exclude results",
    disableFilter: "Temporarily disable",
    enableFilter: "Re-enable",
    disableAll: "Disable all",
    enableAll: "Enable all",
    removeAll: "Remove all",
    filtersNotApplied: "Filters apply to DQL and Lucene only",
    not: "NOT",
    ...
    searchFieldNames: "Search field names",
    ...
    addColumn: "Add",
    removeColumn: "Remove",
    toggleColumn: "Toggle column in table",
    topValues: "Top {count} values",
    noValuesInSample: "No values in the loaded documents",
    emptyString: "(empty string)",
    existsIn: "Exists in {exists} / {total} loaded records",
    ...
    copied: "Copied",
    loadMore: "Load more",
    sampleLimit: "Showing the first {count} documents. Refine your search to see others.",
    showRenderedRows: "Showing {shown} of {total} loaded rows. Show all",
    loading: "Searching…",
    enterIndexPattern: "Enter an index pattern (for example logs-*) to start exploring documents.",
    requestFailed: "Search failed",
    noResults: "No results match your search criteria",
    noResultsHint: "Try a different query or remove some filters.",
    noResultsHintTime: "Try expanding the time range, changing the query or removing filters.",
    noRows: "The query returned no rows",
    runHint: "Press Enter or Refresh to run the query.",
    pplUnsupported: "PPL requires the OpenSearch SQL/PPL plugin; this cluster is Elasticsearch. Use SQL instead.",
  },
  solrAdmin: {
    title: "Solr Admin",
    refresh: "Refresh",
  ...
  dataCompare: {
    ...
    rowCountsTruncated: "Source {source} rows, target {target} rows; stopped at the full-compare row limit",
    truncatedPartial: "This table exceeds the full-compare row limit, so only part of its rows were compared and the sync SQL is incomplete. Use Data Transfer to copy large tables.",
    truncatedMissingTarget: "The target table is missing and the source exceeds the full-compare row limit: only CREATE TABLE was generated, no row data. Use Data Transfer to copy the data.",
    truncatedBanner: "{count} table(s) exceeded the full-compare row limit, so their results and sync SQL are incomplete. Use Data Transfer for large tables.",
  ...
  settings: {
    ...
    syncHttpsRequired: "Use an https:// URL. Plain http:// is only allowed for localhost (127.0.0.0/8, ::1).",
    syncPassphraseTooShort: "Sync passwords must be at least {min} characters.",
    syncPassphraseTooShortExisting: "New sync passwords must be at least {min} characters. A shorter existing password can still be used to download, but it is not saved or used for uploads.",
    syncImportConfirmTitle: "Review cloud sync import",
    syncImportConfirmDescription: "Nothing has been applied yet. Review the changes below before importing the snapshot.",
    syncImportUnauthenticated: "This snapshot is not authenticated; it could have been modified by anyone with write access to the sync storage.",
    syncImportEndpointChangesHint: "These connections have locally saved credentials, but the snapshot changes where they connect:",
    syncImportKeepCredentials: "Import and keep saved credentials",
    syncImportClearCredentials: "Import and clear credentials for changed connections",
    syncImportCancelled: "Import cancelled. Nothing was changed.",
    syncImportDroppedCredentials: "Saved credentials were cleared for {count} changed connection(s).",
    mcpPolicyUnconfiguredReadOnlyHint: "No MCP policy has been saved yet, so MCP access is read-only by default. Choosing a mode or scope saves a policy.",
    ...
    mcpToolKafkaCluster: "Kafka cluster overview",
    mcpToolKafkaListTopics: "List Kafka topics",
    mcpToolKafkaDescribeTopic: "Describe a Kafka topic",
    mcpToolKafkaTopicConfig: "Kafka topic configuration",
    mcpToolKafkaListConsumerGroups: "List Kafka consumer groups",
    mcpToolKafkaConsumerGroup: "Kafka consumer group detail",
    mcpToolKafkaLag: "Kafka consumer lag",
    mcpToolKafkaThroughput: "Kafka throughput and stall status",
    mcpToolOpensearchListIndices: "List OpenSearch index patterns and indices",
    mcpToolOpensearchResolvePattern: "Expand an OpenSearch index pattern",
    mcpToolOpensearchFields: "List OpenSearch fields",
    mcpToolOpensearchSearch: "Search OpenSearch (DQL/Lucene, time window)",
    mcpToolOpensearchSql: "Run OpenSearch SQL",
    mcpToolOpensearchPpl: "Run OpenSearch PPL",
  ...
  esConsole: {
    ...
    copyFailed: "Copy failed: {message}",
    requestEditorLabel: "Console requests",
    responseLabel: "Response",
    responsesCount: "{count} responses",
    copyResponse: "Copy response",
    took: "{ms} ms",
    running: "Running…",
    noResponse: "Run a request to see its response here.",
    noRequest: "Place the cursor on a request (for example GET _search) to run it.",
    requestFailed: "Request failed",
    formatInvalidJson: "Could not auto-indent: the request body is not valid JSON.",
    formatUnsupported: "Could not auto-indent a body that contains comments or triple-quoted strings.",
    confirmMessage: "This request may modify or delete data irreversibly. Are you sure you want to send it?",
    confirmAction: "Send request",
    readOnlyTitle: "Read-only connection",
    readOnlyError: "This connection is read-only, so the cluster was not changed. Unlock writes for this connection or use a writable connection to send write requests.",
    splitterLabel: "Resize request and response panes",
    history: "History",
    historyTitle: "Recent requests ({count})",
    historyEmpty: "No requests have been run on this connection yet.",
    historyClear: "Clear history",
    historyInsert: "Insert into the editor",
    historyTruncated: "body too large, request line only",
    help: "Help",
    helpTitle: "Keyboard shortcuts",
    shortcutRun: "Run the request under the cursor, or every selected request",
    shortcutIndent: "Auto-indent the current request",
    shortcutComment: "Toggle line comment",
    shortcutComplete: "Show suggestions",
    shortcutUndo: "Undo",
    helpSyntax: 'Write each request as METHOD path on its own line, followed by an optional JSON body (NDJSON for _bulk and _msearch). Use # or // for comments and """ for multi-line strings.',
  },
  codeSnapshot: {
    title: "Code Snapshot",
    close: "Close",
